...
static void	get_pairs(void)
{
	...
	init_pair(2, COLORS - 12, COLOR_BLACK);
	init_pair(3, COLORS - 13, COLOR_BLACK);
	init_pair(4, COLORS - 14, COLOR_BLACK);
	init_pair(5, COLOR_BLACK, COLORS - 1);
	init_pair(6, COLORS - 15, COLORS - 19);
	init_pair(7, COLORS - 16, COLORS - 20);
	init_pair(8, COLORS - 17, COLORS - 21);
	init_pair(9, COLORS - 18, COLORS - 22);
	init_pair(10, COLORS - 1, COLOR_BLACK);
	init_pair(11, COLORS - 15, COLOR_BLACK);
	init_pair(12, COLORS - 16, COLOR_BLACK);
	init_pair(13, COLORS - 17, COLOR_BLACK);
	init_pair(14, COLORS - 18, COLOR_BLACK);
	init_pair(15, COLORS - 24, COLOR_BLACK);
	init_pair(16, COLORS - 23, COLOR_BLACK);
	init_pair(17, COLORS - 2, COLORS - 2);
